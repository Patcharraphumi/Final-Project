...
// @ts-nocheck
 ...
 import { Card, Button, Toggle,Spinner,Indicator,CloseButton,Hr ,P} from "flowbite-svelte";
...
{#if topics.length > 0 }
   ...
   <div class="flex flex-col items-center relative">
		<Card size='lg' href='./firstyear/comments/{topic.id}'  class="p-4 sm:p-6 md:p-8 mb-1.5 max-w-2xl max-h-[15rem] rounded-3xl overflow-hidden "  > 
